    ...
    <div class="table-container">
      <el-table ref="productRelationTable"
        ...
        <el-table-column label="货号" width="140" align="center">
          <template slot-scope="scope">NO.{{scope.row.commodity.productSn}}</template>
        </el-table-column>
        <el-table-column label="商品价格" width="100" align="center">
          <template slot-scope="scope">￥{{scope.row.commodity.price}}</template>
        </el-table-column>
        <el-table-column label="剩余数量" width="100" align="center">
          <template slot-scope="scope">{{scope.row.commodity.stock}}</template>
        </el-table-column>
    ...
    <el-dialog title="编辑秒杀商品信息"
      ...
      <el-form :model="flashProductRelation"
        ...
        <el-form-item label="商品名称：">
          <span>{{flashProductRelation.commodity.name}}</span>
        </el-form-item>
        <el-form-item label="货号：">
          <span>NO.{{flashProductRelation.commodity.productSn}}</span>
        </el-form-item>
        <el-form-item label="商品价格：">
          <span>￥{{flashProductRelation.commodity.price}}</span>
        </el-form-item>
        ...
        <el-form-item label="剩余数量：">
          <span>{{flashProductRelation.commodity.stock}}</span>
        </el-form-item>
