          ...
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if(this.isEdit){
                ...
                updateCoupon(this.$route.query.id,params).then(response=>{
        ...
        if (query !== '') {
          ...
          fetchProductList({productName:query,pageNum: 1,
            ...
            for(let i=0;i<productList.length;i++){
              ...
              this.selectProductOptions.push({productId:item.productId,productName:item.productName,productSn:item.productId});
            }
          });
        } else {
          this.selectProductOptions = [];
