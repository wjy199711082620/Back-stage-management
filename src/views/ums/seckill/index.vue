<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">添加场景</el-button>
      <el-button size="mini" class="btn-add" @click="handleImport()">导入场景</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="编号" width="120" align="center">
          <template slot-scope="scope">{{scope.row.seckillId}}</template>
        </el-table-column>
        ...
        <el-table-column label="场景图标" width="120" align="center">
          <template slot-scope="scope"><img style="height: 80px" :src="scope.row.icon"></template>
        </el-table-column>
        <el-table-column label="场景地址" align="center">
          <template slot-scope="scope">{{scope.row.address}}</template>
        </el-table-column>
        <el-table-column label="场景简介" align="center">
...
<script>
  import {fetchList,deleteHomeAdvertise} from '@/api/seckill';
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index,row){
        this.$router.push({path: '/ums/updateSite', query: {seckillId: row.seckillId}})
      },
      getList() {
