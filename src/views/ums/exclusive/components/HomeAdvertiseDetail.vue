  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="homeAdvertise"
     ...
     <!--  <el-form-item label="商品名称：" prop="name">
      ...
      <el-form-item label="专属价格：" prop="name">
        <el-input v-model="homeAdvertise.currentPrice" class="input-width"></el-input>
      </el-form-item>
      <el-form-item label="最小等级：">
        <el-select v-model="homeAdvertise.minimumLevel">
          <el-option
      ...
      <el-form-item label="购买数量限制：" prop="name">
        <el-input v-model="homeAdvertise.quantityRestrictions" class="input-width"></el-input>
      </el-form-item>
...
<script>
  ...
  import {addExclusive, getExclusive, getCityList, updateExclusive} from '@/api/exclusive';
  ...
  export default {
    ...
    data() {
      return {
        homeAdvertise: {provinceCode: '', cityCode:'', districtCode:'', age:'', exclusiveType:'', latitude:'', longitude:''},
        provinceList: null,
        cityList: null,
        districtList:null,
    ...
    created(){
      if (this.isEdit) {
        ...
        console.log('exclusiveId is' + this.$route.query.exclusiveId);
      
        getExclusive({exclusiveId:this.$route.query.exclusiveId}).then(response => {
          ...
          if (valid) {
            this.$confirm('是否提交数据', '提示', {
              ...
              if (this.isEdit) {
                ...
                updateExclusive(this.$route.query.exclusiveId, this.homeAdvertise).then(response => {
                ...
                addExclusive(this.homeAdvertise).then(response => {
                  this.$refs[formName].resetFields();
                  this.homeAdvertise = Object.assign({},defaultHomeAdvertise);
                  this.$message({
                    message: '提交成功',
