    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="4" class="table-cell">{{order.expressCode | formatNull}}</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          <el-col :span="6" class="table-cell">{{order.addressee}}</el-col>
          <el-col :span="6" class="table-cell">{{order.addresseePhone}}</el-col>
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.productIcon" style="height: 80px">
          </template>
        </el-table-column>
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">￥{{order.expressFee}}</el-col>
          <el-col :span="6" class="table-cell">-￥{{order.couponFee}}</el-col>
          <el-col :span="6" class="table-cell">-￥{{order.scoreFee}}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">
            <span class="color-danger">￥{{order.orderAmount+order.expressFee}}</span>
          </el-col>
          <el-col :span="6" class="table-cell">
            <span class="color-danger">￥{{order.orderAmount+order.expressFee-order.couponFee-order.scoreFee}}</span>
          </el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
    ...
    <el-dialog title="修改费用信息"
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">
            <span class="color-danger">￥{{order.orderAmount+moneyInfo.freightAmount}}</span>
          </el-col>
          <el-col :span="6" class="table-cell">
    ...
    methods: {
      ...
      handleMarkOrder(){
        this.$confirm('是否要备注订单?', '提示', {
          ...
          params.append("description",this.markInfo.note);
