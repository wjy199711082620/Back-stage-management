<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="coupon"
      ...
      <el-input v-model="this.$route.query.merchantId"  type="hidden" class="input-width"></el-input>
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$confirm('是否提交数据', '提示', {
                            ...
                            this.coupon.startTime = startDate;
                            this.coupon.endTime = endTime;
                            this.coupon.merchantId = this.$route.query.merchantId;
                            let productIds = "";
                            //循环赋值
                            ...
                            this.coupon.productIds = productIds;
