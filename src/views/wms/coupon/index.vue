    ...
    export default {
        ...
        methods:{
            ...
            handleAdd(){
                ...
                this.$router.push({path: '/wms/addCoupon', query: {merchantId: this.$route.query.merchantId}})
            },
            handleView(index, row) {
                this.$router.push({path: '/ums/couponHistory', query: {id: row.couponId}})
            },
            handleUpdate(index, row) {
                this.$router.push({
                    path: '/wms/updateCoupon',
                    query: {couponId: row.couponId, merchantId: this.$route.query.merchantId}
                })
            },
