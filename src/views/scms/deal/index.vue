      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="话题名称：">
            <el-input v-model="listQuery.dealTitle" class="input-width" placeholder="话题名称"></el-input>
          </el-form-item>
          ...
          <el-form-item label="场景类型：">
            <el-select v-model="listQuery.dealType" placeholder="全部" clearable class="input-width">
    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="话题标题" align="center">
          <template slot-scope="scope">{{scope.row.dealTitle}}</template>
        </el-table-column>
         <el-table-column label="发布人昵称" align="center">
          <template slot-scope="scope">{{scope.row.nickName}}</template>
        </el-table-column>
        <el-table-column label="发布人头像" width="120" align="center">
          <template slot-scope="scope"><img style="height: 50px" :src="scope.row.userIcon"></template>
        </el-table-column>
        ...
        <el-table-column label="话题内容" align="center">
          <template slot-scope="scope">{{scope.row.dealContent}}</template>
        </el-table-column>
...
<script>
  import {fetchList,updateStatus,deleteHomeAdvertise} from '@/api/deal';
