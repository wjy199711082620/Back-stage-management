        ...
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="用户昵称：">
           ...
           <el-form-item label="反馈内容：">
            <el-input v-model="listQuery.content" class="input-width" placeholder="反馈内容"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="newSubjectTable"
        ...
        <el-table-column label="编号" width="120" align="center">
          <template slot-scope="scope">{{scope.row.feedbackId}}</template>
        </el-table-column>
        <el-table-column label="用户昵称" align="center">
          <template slot-scope="scope">{{scope.row.nickName}}</template>
        </el-table-column>
        <el-table-column label="反馈内容" align="center">
          <template slot-scope="scope">{{scope.row.replyContent}}</template>
        </el-table-column>
        ...
        <el-table-column label="官方回复" align="center">
          <template slot-scope="scope">{{scope.row.replyContent}}</template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleEditSort(scope.$index, scope.row)">回复
            </el-button>
            <el-button size="mini"
                       type="text"
    ...
    <el-dialog title="回复反馈"
      ...
      <el-form :model="sortDialogData"
        ...
        <el-form-item >
          ...
          :rows="5"
          placeholder="请输入回复内容"
          v-model="sortDialogData.replyContent">
        </el-input>
        </el-form-item>
      </el-form>
      <span slot="footer">
...
<script>
  import {fetchList,updateRecommendStatus,deleteHomeSubject,createHomeSubject,updateHomeSubjectSort} from '@/api/feedback';
  import {fetchList as fetchSubjectList} from '@/api/feedback';
  ...
  export default {
    ...
    data() {
      return {
        ...
        sortDialogData:{replyContent:null,feedbackId:null}
  }
    },
    created() {
      this.getList();
    ...
    methods: {
      ...
      handleEditSort(index,row){
        ...
        this.sortDialogData.replyContent=row.replyContent;
        this.sortDialogData.feedbackId=row.feedbackId;
      },
      handleUpdateSort(){
        this.$confirm('是否要回复反馈?', '提示', {
